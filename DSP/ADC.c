...
void ADC3_CH12_DMA_Config(void)
{
  ...
  DMA_DoubleBufferModeConfig(DMA2_Stream1,(uint32_t)&ADC3ConvertedValue1,DMA_Memory_0);
  DMA_DoubleBufferModeCmd(DMA2_Stream1, ENABLE);
  DMA_Cmd(DMA2_Stream1, ENABLE);
  DMA_ITConfig(DMA2_Stream1, DMA_IT_TC | DMA_IT_HT, ENABLE);// przerwanie po calosci i po po³owie



  NVIC_InitStructure.NVIC_IRQChannel 						= DMA2_Stream1_IRQn; 																																				//co przerwie
  NVIC_InitStructure.NVIC_IRQChannelPreemptionPriority 		= 1; 																															//piorytet (0 najwiekszy) -3 jest dla resetu; -1, -2 bledy systemowe
